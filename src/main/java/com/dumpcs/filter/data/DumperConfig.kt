...
class DumperConfig {
    ...
    fun loadDefaults() {
        ...
        ensureBool("dumpStaticFieldMetadata", false)
        ensureBool("dumpFieldRvaData", false)
        ensureInt("maxFieldRvaDumpBytes", 64)
        ensureBool("generateGenericsDump", false)
        ensureBool("dumpGenericsRgctx", false)
        ensureBool("dumpGenericsMethodSpecs", false)
        ensureBool("dumpGenericsCustomAttributes", false)
        ensureBool("dumpGenericsStringLiterals", false)
        ensureBool("dumpGenericsMetadataUsages", false)
        ensureBool("dumpGenericsVtables", false)
        ensureBool("dumpGenericsInterfaces", false)
        ensureBool("dumpDisassembly", false)
        ensureBool("dumpDisassemblyHexBytes", false)
        ensureBool("dumpDisassemblyFieldNames", false)
        ensureBool("dumpDisassemblyAnnotations", false)
        ensureBool("dumpDisassemblyCfg", false)
